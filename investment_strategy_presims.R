...
system.time(result <- invest_strategy(burn_in_period = 6*30, tp = .25, sl = .3, single_invest = 100, rawdata = rawdata, verbose = T, charge = .02, nr_days = 500, strategy = 'highvar'))
result$yearly_gain_pct # 43%
system.time(result <- invest_strategy(burn_in_period = 5.7*12*30, tp = .25, sl = .3, single_invest = 100, rawdata = rawdata, verbose = T, charge = .02, nr_days = 365, strategy = 'highvar'))
result$yearly_gain_pct # 43%
